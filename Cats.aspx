<%@ Page Title="" Language="C#" MasterPageFile="~/PetShopMaster.Master" AutoEventWireup="true" CodeBehind="Cats.aspx.cs" Inherits="PetShop.Cats" %>
...
<style>
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:petConnectionString %>" SelectCommand="SELECT * FROM [CatDetails]"></asp:SqlDataSource>
 </center>
 </div>
