<%@ Page Title="" Language="C#" MasterPageFile="~/PetShopMaster.Master" AutoEventWireup="true" CodeBehind="Dogss.aspx.cs" Inherits="PetShop.DogsDemo1" %>
         ...
         .labelprice
       {
           padding-left:50px;
               ...
               <div>
                <center>
                    <h1>DOGS</h1>
                    <asp:DataList ID="DataList1" runat="server" RepeatColumns="3" CellPadding="100" DataKeyField="Id" DataSourceID="SqlDataSource1" CellSpacing="50" OnItemCommand="DataList1_ItemCommand"   >
                        <ItemTemplate>                         
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:petConnectionString %>" SelectCommand="SELECT * FROM [DogDetails]"></asp:SqlDataSource>                    
                </center>
               </div>        
</asp:Content>
