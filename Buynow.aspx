<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PetShopMaster.Master" CodeBehind="Buynow.aspx.cs" Inherits="PetShop.Buynow" %>
...
.btn:hover {
  background-color: #45a049;
        ...
        <asp:Button ID="checkoutbtn" runat="server" Text="Continue to checkout" CssClass="btn" onserverclick="Checkoutbtn_Click" />
      </form>
    </div>
  </div>
</div>
