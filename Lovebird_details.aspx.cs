...
namespace PetShop
{
    public partial class Lovebird_details : System.Web.UI.Page
    {
        SqlConnection conn;
        SqlCommand cmd;
        ...
        public void Admin_Redirect(object sender, EventArgs e) => Response.Redirect("Adminform.aspx");
        public void Add_petBird(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                string insertQuery_pet = "Insert into BirdDetails(Name,Price,Image) values(@name,@dprice,@imageData)";
